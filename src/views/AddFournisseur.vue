      ...
      <ion-content>
        <div class="container">
          ...
          <div class="logo-container">
            <a href="fournisseur"> <!-- Remplacez "/" par l'URL de destination souhaitée -->
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        ...
                        <ion-select v-model="supplier.title" placeholder="Sélectionnez un titre">
                      ...
                      <ion-item class="item">
                        ...
                        <ion-input v-model="supplier.firstName" required></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Nom de famille</ion-label>
                        <ion-input v-model="supplier.lastName"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Entreprise</ion-label>
                        <ion-input v-model="supplier.company"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Nom affiché (*)</ion-label>
                        <ion-input v-model="supplier.displayName" required></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Référence</ion-label>
                        <ion-input v-model="supplier.reference"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Email</ion-label>
                        <ion-input v-model="supplier.email" type="email"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Téléphone</ion-label>
                        <ion-input v-model="supplier.phone" type="tel"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Site Internet</ion-label>
                        <ion-input v-model="supplier.website" type="url"></ion-input>
                      </ion-item>
                    </ion-list>
                  </div>
                </ion-accordion>
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        ...
                        <ion-select v-model="supplier.professionalInfo.type" placeholder="Sélectionnez un type">
                      ...
                      <ion-item class="item">
                        ...
                        <ion-input v-model="supplier.professionalInfo.priceGrid"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Numéro d'identification fiscale</ion-label>
                        <ion-input v-model="supplier.professionalInfo.taxIdentificationNumber"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Activité</ion-label>
                        <ion-input v-model="supplier.professionalInfo.activity"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Agence ou société commerciale</ion-label>
                        <ion-input v-model="supplier.professionalInfo.agencyOrCommercialCompany"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Devise</ion-label>
                        <ion-input v-model="supplier.professionalInfo.currency" value="Dinar(s) tunisien" readonly></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Conditions de paiement</ion-label>
                        <ion-input v-model="supplier.professionalInfo.paymentTerms" value="Payable à réception" readonly></ion-input>
                      </ion-item>
                    </ion-list>
                  </div>
                </ion-accordion>
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        ...
                        <ion-textarea v-model="supplier.remarks"></ion-textarea>
                      </ion-item>
                    </ion-list>
                  </div>
                </ion-accordion>
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        ...
                        <ion-input v-model="supplier.billingAddress.address"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Gouvernorat</ion-label>
                        <ion-input v-model="supplier.billingAddress.governorate"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Code postal</ion-label>
                        <ion-input v-model="supplier.billingAddress.postalCode"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Pays</ion-label>
                        <ion-input v-model="supplier.billingAddress.country" value="Tunisie" readonly></ion-input>
                      </ion-item>
                    </ion-list>
                  </div>
                </ion-accordion>
                ...
                <ion-accordion value="deliveryAddress">
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        <ion-label position="stacked">Adresse</ion-label>
                        <ion-input v-model="supplier.deliveryAddress.address"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Gouvernorat</ion-label>
                        <ion-input v-model="supplier.deliveryAddress.governorate"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Code postal</ion-label>
                        <ion-input v-model="supplier.deliveryAddress.postalCode"></ion-input>
                      </ion-item>
                      <ion-item class="item">
                        <ion-label position="stacked">Pays</ion-label>
                        <ion-input v-model="supplier.deliveryAddress.country" value="Tunisie" readonly></ion-input>
                      </ion-item>
                    </ion-list>
                  </div>
                </ion-accordion>
    ...
    methods: {
      async submitSupplier() {
        try {
          ...
          await axios.post(
            `/${lang}/api/public/company/${companyId}/supplier/new`,
            this.supplier
          );
