...
const { chartData, loading, error, fetchData, fetchDefaultData } = usePurchaseCategories();
...
const shouldUseDefaultDates = (): boolean => {
  // Si aucune période spécifique n'est définie ou si c'est la période par défaut
...
// Surveiller les changements de période - seulement si ce ne sont pas les dates par défaut
