<template>
      ...
      <ion-content :fullscreen="true">
        ...
        <div class="deliveries-header">
          <div class="title-container">
            <ion-label class="title">Modifier Bon de Livraison</ion-label>
        ...
        <div class="content-wrapper">
          <ion-accordion-group class="all">         
            ...
            <ion-item>
                  ...
                  <ion-input v-model="DeliveryForm.object" class="in-cadre" placeholder="Entrer l'objet"></ion-input>
                </ion-item>             
                       <ion-item>
                  <ion-label>Bon de Livraison N°</ion-label>
                  <ion-input 
                    class="in-cadre" 
                    v-model="DeliveryForm.DeliveryNote_number"
                  ></ion-input>
                </ion-item>
               <ion-item>
                  <ion-label>Client</ion-label>
                  <ion-select 
                    v-model="DeliveryForm.client_id" 
                    class="select-input" 
                    @ionChange="onClientSelected"
                  >
                    <ion-select-option 
                      v-for="client in clients" 
                      :key="client.hashed_id" 
                      :value="client.hashed_id"
                    >
                      {{ client.display_name }}
                    </ion-select-option>
                  </ion-select>
              ...
              <ion-item>
                  ...
                  <ion-input v-model="DeliveryForm.referenceNumber" class="in-cadre"></ion-input>
                </ion-item>
   <ion-item>
    ...
    <div v-if="DeliveryForm.items && DeliveryForm.items.length">
                  <div v-for="article in DeliveryForm.items" :key="article.id" class="article-list-item">
                ...
                <ion-radio-group class="radio-group" v-model="DeliveryForm.tax_type">
                  <ion-item lines="none">
                    <div class="taxe">
                ...
                <ion-item>
                  ...
                  <ion-textarea class="in-cadre" placeholder="À payer à réception" v-model="DeliveryForm.generalTerms"></ion-textarea>
                </ion-item>
                <ion-item>
                  <div class="add-files">
    ...
    <ion-item class="custom-item">
      <div class="row">
        ...
        <ion-text class="custom-content">{{ formatPrice(DeliveryForm.totals.subtotal) }}</ion-text>
      </div>
    </ion-item>
  ...
  <ion-item class="custom-item">
    <div class="row">
      ...
      <div class="discount-controls">
        <ion-input
          v-model="DeliveryForm.totals.discount"
          type="number"
    ...
    <ion-item class="custom-item" v-for="item in DeliveryForm.items" :key="item.id">
    ...
    <ion-item class="custom-item" v-if="DeliveryForm.AdditionalEntries?.tva === 1">
      <div class="row">
    ...
    <ion-item class="custom-item">
      <div class="row">
        ...
        <ion-text class="custom-content">{{ formatPrice(DeliveryForm.totals.total) }}</ion-text>
      </div>
              ...
              <div slot="content" class="accordion-content">
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle
                      v-model="DeliveryForm.AdditionalEntries.tva"
                      @update:modelValue="DeliveryForm.AdditionalEntries.tva = $event ? 1 : 0; calculateTotal()"
                      />                    
                  </div>
                </ion-item>
                    <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">example</ion-label>
                    <ion-toggle
                      v-model="DeliveryForm.AdditionalEntries.tva"
                      @update:modelValue="DeliveryForm.AdditionalEntries.tva = $event ? 1 : 0; calculateTotal()"
                      />                    
            ...
            <ion-accordion value="content">
              ...
              <div slot="content" class="accordion-content">
                <ion-item>
                  ...
                  <ion-input class="in-cadre" v-model="DeliveryForm.watermark"></ion-input>
                </ion-item>
          <ion-item>
    <ion-label>PDF language (actuel: {{ DeliveryForm.language }})</ion-label>
    <ion-select class="select-input" v-model="DeliveryForm.language">
      ...
      <ion-select-option value="en">English</ion-select-option>
                ...
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="DeliveryForm.show_description"
                    @ionChange="DeliveryForm.show_description = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items unity</ion-label>
                    <ion-toggle v-model="DeliveryForm.showArticleUnit"
                    @ionChange="DeliveryForm.showArticleUnit = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                  <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                ...
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="DeliveryForm.showArticleTTCPrices"
                    @ionChange="DeliveryForm.showArticleTTCPrices = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items pictures</ion-label>
                    <ion-toggle v-model="DeliveryForm.show_pictures"
                    @ionChange="DeliveryForm.show_pictures = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Billing address</ion-label>
                    <ion-toggle v-model="DeliveryForm.show_billing"
                    @ionChange="DeliveryForm.show_billing = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Delivery address</ion-label>
                    <ion-toggle v-model="DeliveryForm.show_delivery"
                    @ionChange="DeliveryForm.show_delivery = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">General conditions</ion-label>
                    <ion-toggle v-model="DeliveryForm.show_conditions"
                    @ionChange="DeliveryForm.show_conditions = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">               
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Stamp & Signature</ion-label>
                    <ion-toggle v-model="DeliveryForm.show_stamp"
                    @ionChange="DeliveryForm.show_stamp = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                    <div class="a-toggle">
                      <ion-label class="toggle-label">Bank details</ion-label>
                      <ion-toggle v-model="DeliveryForm.show_bank"
                      @update:modelValue="DeliveryForm.show_bank = $event ? 1 : 0"></ion-toggle>
                    </div>
                  </ion-item>
                  <ion-item v-if="DeliveryForm.show_bank === 1">
                    <ion-select v-model="DeliveryForm.selected_bank" class="select-input">
                      <ion-select-option
                        v-for="b in banks"
                        :key="b.hashed_id"
                        :value="b.hashed_id">
            ...
            <ion-accordion value="remarque">
              ...
              <div slot="content" class="accordion-content">
                <ion-textarea placeholder="Entrer des remarques" v-model="DeliveryForm.remarks"></ion-textarea>
              </div>
            </ion-accordion>
          </ion-accordion-group>
  ...
  import { useUpdateDeliverNoteController} from '@/controllers/updateDeliveryNotes';
  ...
  const {
    ...
    bank,
    taxes,
  } = useUpdateDeliverNoteController();
