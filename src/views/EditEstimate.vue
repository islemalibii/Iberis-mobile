<template>
      ...
      <ion-content :fullscreen="true">
        ...
        <div class="deliveries-header">
          <div class="title-container">
            <ion-label class="title">Modifier le Devis </ion-label>
          ...
          <ion-accordion-group class="all">         
            <ion-accordion value="voucherDetails">
              <ion-item class="aTitle" slot="header">
                ...
                <ion-label>Détails du Devis</ion-label>
              </ion-item>
            ...
            <ion-item>
                  ...
                  <ion-input v-model="EstimateForm.object" class="in-cadre" placeholder="Entrer l'objet"></ion-input>
                </ion-item>             
                       <ion-item>
                  <ion-label>Devis N°</ion-label>
                  <ion-input 
                    class="in-cadre" 
                    v-model="EstimateForm.estimate_number"
                  ></ion-input>
                </ion-item>
               <ion-item>
                  <ion-label>Client</ion-label>
                  <ion-select 
                    v-model="EstimateForm.client_id" 
                    class="select-input" 
              ...
              <ion-item>
                  ...
                  <ion-input v-model="EstimateForm.referenceNumber" class="in-cadre"></ion-input>
                </ion-item>
   <ion-item>
    ...
    <div v-if="EstimateForm.items && EstimateForm.items.length">
                  <div v-for="article in EstimateForm.items" :key="article.id" class="article-list-item">
                ...
                <ion-radio-group class="radio-group" v-model="EstimateForm.tax_type">
                  <ion-item lines="none">
                    <div class="taxe">
                ...
                <ion-item>
                  ...
                  <ion-textarea class="in-cadre" placeholder="À payer à réception" v-model="EstimateForm.generalTerms"></ion-textarea>
                </ion-item>
                <ion-item>
                  <div class="add-files">
    ...
    <ion-item class="custom-item">
      <div class="row">
        ...
        <ion-text class="custom-content">{{ formatPrice(EstimateForm.totals.subtotal) }}</ion-text>
      </div>
    </ion-item>
  ...
  <ion-item class="custom-item">
    <div class="row">
      ...
      <div class="discount-controls">
        <ion-input
          v-model="EstimateForm.totals.discount"
          type="number"
    ...
    <ion-item class="custom-item" v-for="item in EstimateForm.items" :key="item.id">
    ...
    <ion-item class="custom-item" v-if="EstimateForm.AdditionalEntries?.tva === 1">
      <div class="row">
    ...
    <ion-item class="custom-item">
      <div class="row">
        ...
        <ion-text class="custom-content">{{ formatPrice(EstimateForm.totals.total) }}</ion-text>
      </div>
            ...
            <!-- entrees sup Section -->
            <!-- Section Entrees supplementaires -->
    ...
    <div slot="content" class="accordion-content">
      <ion-item lines="none" class="toggle-row">
        <div class="a-toggle">
          ...
          <ion-toggle
            v-model="EstimateForm.activeAdditionalInputs.tva"
      ...
      <ion-item lines="none" class="toggle-row">
        <div class="a-toggle">
          ...
          <ion-toggle
            v-model="EstimateForm.activeAdditionalInputs.stamp"
            @ionChange="calculateTotals"
          />                    
        </div>
      </ion-item>
      <ion-item lines="none" class="toggle-row">
        <div class="a-toggle">
          ...
          <ion-toggle
            v-model="EstimateForm.activeAdditionalInputs.example"
            @ionChange="calculateTotals"
          />                    
        </div>
      </ion-item>
            ...
            <ion-accordion value="content">
              ...
              <div slot="content" class="accordion-content">
                <ion-item>
                  ...
                  <ion-input class="in-cadre" v-model="EstimateForm.watermark"></ion-input>
                </ion-item>
          <ion-item>
    <ion-label>PDF language (actuel: {{ EstimateForm.language }})</ion-label>
    <ion-select class="select-input" v-model="EstimateForm.language">
      ...
      <ion-select-option value="en">English</ion-select-option>
                ...
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="EstimateForm.show_description"
                    @ionChange="EstimateForm.show_description = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items unity</ion-label>
                    <ion-toggle v-model="EstimateForm.showArticleUnit"
                    @ionChange="EstimateForm.showArticleUnit = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                  <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items  TTC Prices</ion-label>
                    <ion-toggle v-model="EstimateForm.showArticleTTCPrices"
                    @ionChange="EstimateForm.showArticleUnit = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                ...
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="EstimateForm.show_pictures"
                    @ionChange="EstimateForm.show_pictures = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Billing address</ion-label>
                    <ion-toggle v-model="EstimateForm.show_billing"
                    @ionChange="EstimateForm.show_billing = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Delivery address</ion-label>
                    <ion-toggle v-model="EstimateForm.show_delivery"
                    @ionChange="EstimateForm.show_delivery = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">General conditions</ion-label>
                    <ion-toggle v-model="EstimateForm.show_conditions"
                    @ionChange="EstimateForm.show_conditions = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">               
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Stamp & Signature</ion-label>
                    <ion-toggle v-model="EstimateForm.show_stamp"
                    @ionChange="EstimateForm.show_stamp = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                    <div class="a-toggle">
                      <ion-label class="toggle-label">Bank details</ion-label>
                      <ion-toggle v-model="EstimateForm.show_bank"
                      @update:modelValue="EstimateForm.show_bank = $event ? 1 : 0"></ion-toggle>
                    </div>
                  </ion-item>
                  <ion-item v-if="EstimateForm.show_bank === 1">
                    <ion-select v-model="EstimateForm.selected_bank" class="select-input">
                      <ion-select-option
                        v-for="b in banks"
                        :key="b.hashed_id"
                        :value="b.hashed_id">
            ...
            <ion-accordion value="remarque">
              ...
              <div slot="content" class="accordion-content">
                <ion-textarea placeholder="Entrer des remarques" v-model="EstimateForm.remarks"></ion-textarea>
              </div>
            </ion-accordion>
          </ion-accordion-group>
  ...
  import { useUpdateEstimateController} from '@/controllers/EditEstimateController';
