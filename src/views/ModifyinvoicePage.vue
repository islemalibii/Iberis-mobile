      ...
      <ion-content :fullscreen="true">
        <div class="factures-header">
          <div class="header-row">
            <ion-label class="title">Modify invoices</ion-label>
          ...
          <ion-popover ref="actionPopover" trigger="action-trigger" trigger-action="click">
            <ion-content>
              <ion-list class="actions-top">
                <ion-item button detail="false" @click="handleAction('preview')">Preview</ion-item>
                <ion-item button detail="false" @click="handleAction('download')">Download</ion-item>
                <ion-item button detail="false" @click="handleAction('send')">Send</ion-item>
                <ion-item button detail="false" @click="handleAction('delete')">Delete</ion-item>
              </ion-list>
            </ion-content>
          </ion-popover>
        </div>  
        <div class="status-container" v-if="invoiceStatus === 'Overdue' || invoiceStatus === 'Sent'">
          <ion-button class="overdue-button" @click="openPaymentModal">New payment</ion-button>
        ...
        <div class="content-wrapper">
          ...
          <ion-accordion-group class="all">         
              ...
              <div slot="content" class="accordion-content">
                ...
                <ion-item>
                  ...
                  <div class="in-cadre">
                    ...
                    <ion-input placeholder="Sequence Number"></ion-input>
                  </div>
                </ion-item>             
                <ion-item>
                ...
                <div class="inv-adresses">
                  <p class="inv-adress">Invoicing adress</p>
                  <p class="adresses">Tunisia</p>
                  <p class="inv-adress">Delivering adress</p>
                  <p class="adresses">Tunisia</p>
                </div>
            ...
            <ion-accordion value="tax" v-if="invoiceStatus === 'Overdue' || invoiceStatus === 'Sent'">
              <ion-item class="aTitle" slot="header">
                <ion-icon :icon="chatbubbleOutline"></ion-icon>
                <ion-label>Withholding tax</ion-label>
              </ion-item>
              <div slot="content" class="accordion-content">
                <ion-item>
                  <ion-select class=select-input valie="none">
                    <ion-select-option value="none">none</ion-select-option>
                    <ion-select-option value="7011">hajet okhra</ion-select-option>
                  </ion-select>
                </ion-item>
              </div>
            </ion-accordion>
            <!-- l currency kenky l client bel euro -->
            <!-- devise Section -->
              ...
              <div slot="content" class="accordion-content">
                <ion-item>
                  ...
                  <div class="input-button-container">
                    <ion-input class="in-cadre" value="3.315"></ion-input>
            ...
            <ion-accordion value="additional-inputs">
              <ion-item class="aTitle" slot="header">
                <ion-icon :icon="chatbubbleOutline"></ion-icon>
                <ion-label>Additional inputs</ion-label>
              </ion-item>
              <div slot="content" class="accordion-content">
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
        ...
        <ion-modal :is-open="isCategoryModalOpen" @didDismiss="closeCategoryModal" class="add-category-model">
          ...
          <ion-content class="ion-padding">
            <ion-item>
              <ion-input class="in-cadre-in-modal" v-model="newCategory" placeholder="Service"></ion-input>
            </ion-item>
        ...
        <!-- Add the Modal for New  Payment -->
        <ion-modal :isOpen="isPaymentModalOpen" @didDismiss="closePaymentModal" class="add-newpayment-model">
          <ion-header>
            <ion-toolbar>
          ...
          <ion-content class="ion-padding">
            ...
            <ion-item>
              <ion-label class="newpayment-label">Payment method</ion-label>
            ...
            <ion-item>
              <ion-label class="newpayment-label">Payment n°</ion-label>
              <div class="newpayment-paidamount">
            ...
            <ion-item>
              <ion-label class="newpayment-label">Reference</ion-label>
              <div class="newpayment-paidamount">
                <ion-input class="newpayment-paid-input"></ion-input>
              </div>
            </ion-item>
            <ion-item>
              <ion-label class="newpayment-label">PDF language</ion-label>
              <ion-select  class ="newpayment-select" value="french">
            ...
            <div class="add-article-modal-actions">
              <ion-button color="danger" @click="closePaymentModal">Fermer</ion-button>
              <ion-button color="primary" @click="addPayments">Ajouter</ion-button>
            </div>
          </ion-content>
        </ion-modal>
    </ion-content>
...
<script setup>
  ...
  import { 
    ...
    person, briefcase, documentText, home, location, addOutline, checkmarkCircleOutline,  chevronBackOutline, chevronForwardOutline,refreshOutline
  } from 'ionicons/icons';
...
const typeOptions = [
  ...
  const invoiceStatus = ref(route.query.status || 'pending');
  ...
  onMounted(() => {
    console.log("Invoice Status:", invoiceStatus.value);
  });
  // Supplier Form Data
  const supplier = ref({
    title: '',
...
<style scoped>
  ...
  .add-newpayment-model ion-content {
    --color: #000 !important;
    --padding-start: 16px;
    --padding-end: 16px;
    --padding-top: 16px;
