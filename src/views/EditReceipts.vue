<template>
      ...
      <ion-content :fullscreen="true">
        ...
        <div class="receipts-header">
          <div class="title-container">
            <ion-label class="title">Modifier Bon de Réception</ion-label>
        ...
        <div class="content-wrapper">
          <ion-accordion-group class="all">         
            <ion-accordion value="receiptDetails">
              ...
              <div slot="content" class="accordion-content">
                ...
                <ion-item>
                  ...
                  <ion-input v-model="ReceiptForm.object" class="in-cadre" placeholder="Entrer l'objet"></ion-input>
                </ion-item>             
                <ion-item>
                  <ion-label>Bon de Réception N°</ion-label>
                  <ion-input 
                    class="in-cadre" 
                    v-model="ReceiptForm.receipt_number"
                  ></ion-input>
                </ion-item>
                <ion-item>
                  <ion-label>Fournisseur</ion-label>
                  <ion-select 
                    v-model="ReceiptForm.provider_id" 
                    class="select-input" 
                    @ionChange="onProviderSelected"
                  >
                    <ion-select-option 
                      v-for="provider in providers" 
                      :key="provider.hashed_id" 
                      :value="provider.hashed_id"
                    >
                ...
                <ion-item>
                  ...
                  <ion-input v-model="ReceiptForm.referenceNumber" class="in-cadre"></ion-input>
                </ion-item>
                <ion-item>
                  <ion-label position="stacked">Adresse de facturation</ion-label>
                  <ion-textarea
                    v-model="billingAddress"
                    placeholder="Adresse non disponible"
                    auto-grow
                    readonly
                  ></ion-textarea>
                </ion-item>
                ...
                <div v-if="ReceiptForm.items && ReceiptForm.items.length">
                  <div v-for="article in ReceiptForm.items" :key="article.id" class="article-list-item">
                    <ion-item @click="openArticleDetailsModal(article)" button detail="false">
                      <div class="article-container">
                        ...
                        <ion-button @click.stop="removeArticle(article.id)" class="delete-articale-btn">
                ...
                <ion-radio-group class="radio-group" v-model="ReceiptForm.tax_type">
                  <ion-item lines="none">
                    <div class="taxe">
                ...
                <ion-item>
                  ...
                  <ion-textarea class="in-cadre" placeholder="À payer à réception" v-model="ReceiptForm.generalTerms"></ion-textarea>
                </ion-item>
                <ion-item>
                  <div class="add-files">
                    <ion-label class="attachments-label">Attachments</ion-label>
                    <div class="file-selection-container">
                      <ion-button class="add-file" @click="triggerFileInput" v-model="ReceiptForm.show_pictures">Choose Files</ion-button>
                ...
                <div class="totals">
                  <ion-item class="custom-item">
                    <div class="row">
                      ...
                      <ion-text class="custom-content">{{ formatPrice(ReceiptForm.totals.subtotal) }}</ion-text>
                    </div>
                  </ion-item>
                  ...
                  <ion-item class="custom-item">
                    <div class="row">
                      ...
                      <div class="discount-controls">
                        <ion-input
                          v-model="ReceiptForm.totals.discount"
                          type="number"
                  ...
                  <ion-item class="custom-item" v-for="item in ReceiptForm.items" :key="item.id">
                  ...
                  <ion-item class="custom-item" v-if="ReceiptForm.AdditionalEntries?.tva === 1">
                    <div class="row">
                  ...
                  <ion-item class="custom-item">
                    <div class="row">
                      ...
                      <ion-text class="custom-content">{{ formatPrice(ReceiptForm.totals.total) }}</ion-text>
                    </div>
                  </ion-item>
                </div>
              </div>
            ...
            <ion-accordion value="entrees-sup">
              <ion-item class="aTitle" slot="header">
                <ion-icon :icon="chatbubbleOutline"></ion-icon>
                <ion-label>Entrées supplémentaires</ion-label>
              </ion-item>
              <div slot="content" class="accordion-content">
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle
                      v-model="ReceiptForm.AdditionalEntries.tva"
                      @update:modelValue="ReceiptForm.AdditionalEntries.tva = $event ? 1 : 0; calculateTotal()"
                    />                    
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
            ...
            <ion-accordion value="content">
              ...
              <div slot="content" class="accordion-content">
                <ion-item>
                  ...
                  <ion-input class="in-cadre" v-model="ReceiptForm.watermark"></ion-input>
                </ion-item>
                <ion-item>
                  <ion-label>PDF language (actuel: {{ ReceiptForm.language }})</ion-label>
                  <ion-select class="select-input" v-model="ReceiptForm.language">
                ...
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="ReceiptForm.show_description"
                    @ionChange="ReceiptForm.show_description = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items unity</ion-label>
                    <ion-toggle v-model="ReceiptForm.showArticleUnit"
                    @ionChange="ReceiptForm.showArticleUnit = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items Prices</ion-label>
                    <ion-toggle v-model="ReceiptForm.showArticleUnit"
                    @ionChange="ReceiptForm.showArticleUnit = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    ...
                    <ion-toggle v-model="ReceiptForm.showArticleTTCPrices"
                    @ionChange="ReceiptForm.showArticleTTCPrices = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Items pictures</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_pictures"
                    @ionChange="ReceiptForm.show_pictures = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Billing address</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_billing"
                    @ionChange="ReceiptForm.show_billing = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Delivery address</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_delivery"
                    @ionChange="ReceiptForm.show_delivery = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">General conditions</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_conditions"
                    @ionChange="ReceiptForm.show_conditions = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">               
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Stamp & Signature</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_stamp"
                    @ionChange="ReceiptForm.show_stamp = $event.detail.checked ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item lines="none" class="toggle-row">
                  <div class="a-toggle">
                    <ion-label class="toggle-label">Bank details</ion-label>
                    <ion-toggle v-model="ReceiptForm.show_bank"
                    @update:modelValue="ReceiptForm.show_bank = $event ? 1 : 0"></ion-toggle>
                  </div>
                </ion-item>
                <ion-item v-if="ReceiptForm.show_bank === 1">
                  <ion-select v-model="ReceiptForm.selected_bank" class="select-input">
                    <ion-select-option
                      v-for="b in banks"
                      :key="b.hashed_id"
                      :value="b.hashed_id">
            ...
            <ion-accordion value="remarque">
              ...
              <div slot="content" class="accordion-content">
                <ion-textarea placeholder="Entrer des remarques" v-model="ReceiptForm.remarks"></ion-textarea>
              </div>
            </ion-accordion>
          </ion-accordion-group>
          <div class="add-receipt-container">
            <ion-button @click="validateAndSubmit" class="add-receipt">Mettre à jour</ion-button>
          </div>
        </div>
          ...
          <ion-content class="ion-padding" v-if="selectedArticle">
            ...
            <ion-item class="tax-item">
              ...
              <div class="tax-container" v-for="(tax, index) in selectedArticle.taxes" :key="index">
                <ion-select class="tax-select" :value="tax.hashed_id" @update:modelValue="onTaxChange($event, selectedArticle.id, index)">
                  <ion-select-option 
                    v-for="t in taxes" 
                    :key="t.hashed_id" 
                    :value="t.hashed_id">
                ...
                <ion-button class="delete-tax-btn" @click="removeTax(selectedArticle.id, index)">
                  <ion-icon :icon="trashOutline"></ion-icon>
                </ion-button>
  ...
  import { 
    ...
    chevronBackOutline, chevronForwardOutline, createOutline, calendarOutline, chatbubbleOutline,
    refreshOutline
  } from 'ionicons/icons';
  
  import { useUpdateReceiptController } from '@/controllers/EditReceiptController';
  ...
  const refreshCurrencyRate = () => {
    // Implémentez la logique de rafraîchissement du taux de change ici
    console.log('Refresh currency rate');
  };
  </script>
