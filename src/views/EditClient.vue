<template>
                  ...
                  <div slot="content" class="accordion-content">
                    <ion-list>
                      <ion-item class="item">
                        ...
                        <ion-input v-model="client.displayName" required></ion-input>
                      </ion-item>
                      <ion-item class="item">
  ...
  export default {
    ...
    props: {
      id: String, // ID du client passé via la route
    },
    data() {
      return {
        client: {
    ...
    methods: {
      async fetchClient() {
        try {
          ...
          const response = await axios.get(
            `/${lang}/api/public/company/${companyId}/client/${this.id}`
          );
      ...
      async updateClient() {
        try {
          ...
          const companyId = this.$route.params.companyId; // ID de l'entreprise
          await axios.post(
            `/${lang}/api/public/company/${companyId}/client/${this.id}/edit`,
            this.client
          );
